...
const tools = [
  { icon: '👥', label: '我的学员', url: '/coach/students/index', bg: '#EEF6FF' },
  { icon: '📊', label: '评估管理', url: '/coach/assessment/index', bg: '#F0FBF6' },
  { icon: '🔄', label: 'AI飞轮', url: '/coach/flywheel/index', bg: '#FFF8EE' },
  { icon: '📈', label: '数据分析', url: '/coach/analytics/index', bg: '#EEF6FF' },
  { icon: '📤', label: '推送队列', url: '/coach/push-queue/index', bg: '#F0FBF6' },
  { icon: '🛡️', label: '风险管理', url: '/coach/risk/index', bg: '#FFF2F2' },
  { icon: '📡', label: '直播中心', url: '/coach/live/index', bg: '#FFF8EE' },
  { icon: '💬', label: '学员会话', url: '/coach/messages/index', bg: '#F5F0FF' },
]
