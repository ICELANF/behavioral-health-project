...
const coreMetrics = computed(() => {
  ...
  return [
    { label: '管理学员', value: students.value.length, color: '#3498DB', url: '/coach/students/index' },
    { label: '高风险', value: students.value.filter(s => (s.risk_level || 0) >= 3).length, color: '#E74C3C', url: '/coach/risk/index' },
    { label: '行动完成率', value: actionRate.value + '%', color: '#27AE60', url: '' },
    { label: '待处理', value: stats.pending_reviews || stats.pending_followups || 0, color: '#E67E22', url: '/coach/assessment/index' },
  ]
})
